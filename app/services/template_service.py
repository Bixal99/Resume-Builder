...
TEMPLATE_REGISTRY: dict[str, TemplateInfo] = {
    ...
    "harvard_ats": TemplateInfo(
        id="harvard_ats",
        name="Harvard ATS Standard",
        description="Classical Ivy-League academic & corporate standard. Black-and-white, highly authoritative, 100% ATS compatibility.",
        category="professional",
        is_premium=False,
    ),
    ...
    "minimalist": TemplateInfo(
        ...
        description="Ultra-clean, distraction-free layout with refined typography and maximum information density.",
        category="minimal",
        is_premium=False,
    ),
    "creative": TemplateInfo(
        ...
        description="Contemporary design with distinct visual accents, ideal for design, product, and startup leaders.",
        category="creative",
        is_premium=False,
    ),
}
...
class TemplateService:
    ...
    def __init__(self):
        ...
        self.env.filters["format_url"] = format_url
